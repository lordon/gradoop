...
public class NormalizedTableSet extends GVETableSet implements BaseTableSet {
  ...
  static final TableSetSchema SCHEMA = new TableSetSchema(
    ...
    .put(TABLE_VERTEX_PROPERTY_VALUES, new TableSchemaBuilder()
    ...
    .put(TABLE_EDGE_PROPERTY_VALUES, new TableSchemaBuilder()
    ...
    .put(TABLE_GRAPH_PROPERTY_VALUES, new TableSchemaBuilder()
