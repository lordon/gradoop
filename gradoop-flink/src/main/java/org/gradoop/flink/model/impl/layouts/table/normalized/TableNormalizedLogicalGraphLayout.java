...
import org.gradoop.flink.model.impl.layouts.table.normalized.operators.Combination;
import org.gradoop.flink.model.impl.layouts.table.normalized.operators.Exclusion;
import org.gradoop.flink.model.impl.layouts.table.normalized.operators.Grouping;
import org.gradoop.flink.model.impl.layouts.table.normalized.operators.Overlap;
import org.gradoop.flink.model.impl.layouts.table.normalized.operators.Subgraph;
...
/**
 * Normalized layout of {@link TableLogicalGraph}
 */
public class TableNormalizedLogicalGraphLayout extends TableNormalizedLayout
  implements TableLogicalGraphLayout {
   ...
   */
  TableNormalizedLogicalGraphLayout(NormalizedTableSet tableSet, GradoopFlinkConfig config) {
