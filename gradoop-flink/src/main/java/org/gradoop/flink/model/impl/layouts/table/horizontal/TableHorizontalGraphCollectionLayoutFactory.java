...
/**
 * Responsible for creating instances of {@link TableHorizontalGraphCollectionLayout}
 */
public class TableHorizontalGraphCollectionLayoutFactory extends TableHorizontalBaseLayoutFactory
  implements TableGraphCollectionLayoutFactory<HorizontalTableSet> {

  @Override
  public TableGraphCollectionLayout fromTableSet(TableSet tableSet) {
    return new TableHorizontalGraphCollectionLayout(new HorizontalTableSet(tableSet), getConfig());
  }
  ...
  public TableGraphCollectionLayout fromDataSets(DataSet<GraphHead> graphHeads,
    ...
    return new TableHorizontalGraphCollectionLayout(tableSetFromDataSets, getConfig());
  }
