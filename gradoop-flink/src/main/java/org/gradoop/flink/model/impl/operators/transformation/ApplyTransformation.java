 ...
 * collection.
 */
public class ApplyTransformation extends Transformation<GraphHead, Vertex, Edge,
  LogicalGraphFactory, LogicalGraphLayoutFactory<GraphHead, Vertex, Edge>, LogicalGraph>
