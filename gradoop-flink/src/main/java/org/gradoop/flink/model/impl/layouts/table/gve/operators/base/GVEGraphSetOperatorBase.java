...
/**
 * Base class for all graph set operator implementations in GVE table layout,
 * like Combination, Exclusion and Overlap
 */
public abstract class GVEGraphSetOperatorBase extends TableGraphSetOperatorBase<GVETableSet,
  GVETableSetFactory> {
