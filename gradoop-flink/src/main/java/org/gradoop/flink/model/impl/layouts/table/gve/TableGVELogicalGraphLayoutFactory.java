...
/**
 * Responsible for creating instances of {@link TableGVELogicalGraphLayout}
 */
public class TableGVELogicalGraphLayoutFactory extends TableGVEBaseLayoutFactory
  implements TableLogicalGraphLayoutFactory<GVETableSet> {

  @Override
  public TableLogicalGraphLayout fromTableSet(TableSet tableSet) {
    return new TableGVELogicalGraphLayout(new GVETableSet(tableSet), getConfig());
  }
  ...
  public TableLogicalGraphLayout fromDataSets(DataSet<GraphHead> graphHeads,
    ...
    return new TableGVELogicalGraphLayout(tableSetFromDataSets, getConfig());
  }
