...
/**
 * Responsible for creating instances of {@link TableNormalizedLogicalGraphLayout}
 */
public class TableNormalizedLogicalGraphLayoutFactory extends TableNormalizedBaseLayoutFactory
  implements TableLogicalGraphLayoutFactory<NormalizedTableSet> {

  @Override
  public TableLogicalGraphLayout fromTableSet(TableSet tableSet) {
    return new TableNormalizedLogicalGraphLayout(new NormalizedTableSet(tableSet),
      getConfig());
  }
  ...
  public TableLogicalGraphLayout fromDataSets(DataSet<GraphHead> graphHeads,
    ...
    return new TableNormalizedLogicalGraphLayout(tableSetFromDataSets, getConfig());
  }
