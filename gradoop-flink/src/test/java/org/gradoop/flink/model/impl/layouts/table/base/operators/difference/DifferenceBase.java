 ...
 */
package org.gradoop.flink.model.impl.layouts.table.base.operators.difference;
...
public abstract class DifferenceBase extends TableGradoopFlinkTestBase {
  ...
  public void testOverlappingCollections() throws Exception {
    ...
    TableGraphCollection result = col02.difference(col12);
  ...
  public void testNonOverlappingCollections() throws Exception {
    ...
    TableGraphCollection result = col01.difference(col23);
    checkAssertions(loader.getGraphCollectionByVariables("g0", "g1"), result, "non");
  }
  ...
  public void testTotalOverlappingCollections() throws Exception {
    ...
    TableGraphCollection col01 = loader.getTableGraphCollectionByVariables("g0");

    GraphCollection expectation = getConfig().getGraphCollectionFactory().createEmptyCollection();

    TableGraphCollection result = col01.difference(col01);
  ...
  protected void checkAssertions(GraphCollection expectation,
    ...
    assertTrue(
      "wrong graph data for" + attribute + " overlapping collections",
      result.equalsByGraphData(expectation).collect().get(0));
  }
