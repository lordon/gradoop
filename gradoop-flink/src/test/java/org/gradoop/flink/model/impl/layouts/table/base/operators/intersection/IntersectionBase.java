 ...
 */
package org.gradoop.flink.model.impl.layouts.table.base.operators.intersection;
...
public abstract class IntersectionBase extends TableGradoopFlinkTestBase {
  ...
  public void testOverlappingCollections() throws Exception {
    ...
    TableGraphCollection result = col02.intersect(col12);
  ...
  public void testNonOverlappingCollections() throws Exception {
    ...
    TableGraphCollection result = col01.intersect(col23);
  ...
  public void testTotalOverlappingCollections() throws Exception {
    ...
    TableGraphCollection result = tExpectation.intersect(tExpectation);
