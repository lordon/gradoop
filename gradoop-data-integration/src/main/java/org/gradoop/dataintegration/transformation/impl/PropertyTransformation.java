 ...
 * @param <LGF> the type of the logical graph factory
 * @param <LGLF> the type of the logical graph layout factory
...
public class PropertyTransformation<
  ...
  E extends EPGMEdge,
  LGF extends BaseGraphFactory<G, V, E, LG, LGLF>,
  LGLF extends BaseLayoutFactory,
  LG extends BaseGraph<G, V, E, LG, LGF>> implements UnaryBaseGraphToBaseGraphOperator<LG> {
  ...
  public LG execute(LG graph) {
    return new Transformation<G, V, E, LGF, LGLF, LG>(
