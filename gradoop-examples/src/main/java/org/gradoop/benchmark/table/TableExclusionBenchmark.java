...
/**
 * A dedicated program for benchmark of Exclusion operator. Operator can be executed in dataset
 * implementation or in one of the implementation based on Table-API.
 */
public class TableExclusionBenchmark extends TableSetOperatorBaseBenchmark {
  ...
  public static void main(String[] args) throws Exception {
    CommandLine cmd = parseArguments(args, TableExclusionBenchmark.class.getName());
    ...
    if (USE_TABLE_LAYOUT) {
      ...
      firstSource.getLogicalGraph().exclude(secondSource.getLogicalGraph())
