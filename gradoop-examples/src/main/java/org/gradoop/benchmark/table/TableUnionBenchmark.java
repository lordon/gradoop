...
/**
 * A dedicated program for benchmark of Union operator. Operator can be executed in dataset
 * implementation or in one of the implementation based on Table-API.
 */
public class TableUnionBenchmark extends TableSetOperatorBaseBenchmark {
  ...
  public static void main(String[] args) throws Exception {
    CommandLine cmd = parseArguments(args, TableUnionBenchmark.class.getName());
    ...
    if (USE_TABLE_LAYOUT) {
      ...
      firstSource.getGraphCollection().union(secondSource.getGraphCollection())
