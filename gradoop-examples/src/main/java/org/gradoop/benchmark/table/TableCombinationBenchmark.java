...
/**
 * A dedicated program for benchmark of Combination operator. Operator can be executed in dataset
 * implementation or in one of the implementation based on Table-API.
 */
public class TableCombinationBenchmark extends TableSetOperatorBaseBenchmark {
  ...
  public static void main(String[] args) throws Exception {
    CommandLine cmd = parseArguments(args, TableCombinationBenchmark.class.getName());
    ...
    if (USE_TABLE_LAYOUT) {
      ...
      firstSource.getLogicalGraph().combine(secondSource.getLogicalGraph())
