...
/**
 * A dedicated program for benchmark of Overlap operator. Operator can be executed in dataset
 * implementation or in one of the implementation based on Table-API.
 */
public class TableOverlapBenchmark extends TableSetOperatorBaseBenchmark {
  ...
  public static void main(String[] args) throws Exception {
    CommandLine cmd = parseArguments(args, TableOverlapBenchmark.class.getName());
    ...
    if (USE_TABLE_LAYOUT) {
      ...
      firstSource.getLogicalGraph().overlap(secondSource.getLogicalGraph())
