...
/**
 * A dedicated program for benchmark of Intersection operator. Operator can be executed in dataset
 * implementation or in one of the implementation based on Table-API.
 */
public class TableIntersectionBenchmark extends TableSetOperatorBaseBenchmark {
  ...
  public static void main(String[] args) throws Exception {
    CommandLine cmd = parseArguments(args, TableIntersectionBenchmark.class.getName());
    ...
    if (USE_TABLE_LAYOUT) {
      ...
      firstSource.getGraphCollection().intersect(secondSource.getGraphCollection())
